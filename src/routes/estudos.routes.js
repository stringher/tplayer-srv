...
module.exports = (express) => {
    ...
    route.get("/:id_grupo/categorias/:id_categoria/estudos", adminRole, controller.index)
    ...
    route.get("/:id_grupo/categorias/:id_categoria/estudos/:id_estudo", adminRole, controller.get)
